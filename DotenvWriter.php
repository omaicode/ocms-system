...
use Modules\System\Contracts\FormatterInterface;
use Modules\System\Contracts\WriterInterface;
use Modules\System\Exceptions\UnableWriteToFileException;
...
class DotenvWriter implements WriterInterface
{
     ...
     *
     * @var \Modules\System\Workers\Formatters\Formatter
     */
    protected $formatter;
