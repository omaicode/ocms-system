...
use Modules\System\Contracts\ParserInterface;
use Modules\System\Contracts\ReaderInterface;
use Modules\System\Exceptions\UnableReadFileException;
...
class DotenvReader implements ReaderInterface
{
     ...
     *
     * @var \Modules\System\Workers\Parsers\Parser
     */
    protected $parser;
